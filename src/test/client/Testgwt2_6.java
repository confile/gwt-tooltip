 ...
 */
public class Testgwt2_6 implements EntryPoint {
	/**
...
//		options.withSelector(".tooltip");
//		$("[title]").as(Tooltip).tooltip(options);
		
		TooltipOptions options = new TooltipOptions();
        options.withSelector("[title]");
        options.withAutoClose(true);
        $("body").as(Tooltip).tooltip(options);
		
		Anchor test = new Anchor();
		test.setText("testststststst");
		test.setTitle("lalallalal");
		test.addStyleName("tooltip");
